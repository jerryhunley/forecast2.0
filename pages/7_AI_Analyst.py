...
def get_coder_prompt(_df_info, _ts_col_map_str):
    ...
    # --- THIS FUNCTION HAS BEEN REWRITTEN TO FIX THE SYNTAX ERROR ---
    return f"""You are a world-class Python data analyst. Your goal is to answer the user's question about recruitment data by generating a single, executable Python code block.
...
- `ts_col_map`: A dictionary mapping stage names to timestamp columns. Here is the exact dictionary: `{_ts_col_map_str}`
